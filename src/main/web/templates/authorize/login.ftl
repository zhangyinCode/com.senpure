...
<head>
    ...
    <meta charset="UTF-8">
    <title><spring:message code="login.html.title" /></title>
...
<div class="container">
    ...
    <div class="row">
        ...
        <form:form action="authorize/login" commandName="criteria" method="post"
            ...
            <!-- <div class="form-group">
            <button class="form-control btn btn-info " type="reset">
