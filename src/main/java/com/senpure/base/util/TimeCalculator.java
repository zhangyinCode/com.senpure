...
public class TimeCalculator {
	 ...
	 * @return
	 */
	private static int synchronization_WEEK_Calendar(WEEK firstDayOfWeek) {
		int _firstDayOfWeek = firstDayOfWeek.ordinal() + 2;
		if (_firstDayOfWeek > 7) {
			_firstDayOfWeek -= 7;
		}
	...
	public static int getDayOfWeek(Calendar calendar, WEEK firstDayOfWeek) {
		...
		calendar.setFirstDayOfWeek(synchronization_WEEK_Calendar(firstDayOfWeek));
		return calibrationDayOfWeek(calendar);
	}
	...
	public static Calendar getWeekBegin(Calendar calendar, WEEK firstDayOfWeek) {
		Calendar c = Calendar.getInstance();
		c.setTimeInMillis(calendar.getTimeInMillis());
		c.setFirstDayOfWeek(synchronization_WEEK_Calendar(firstDayOfWeek));
		toWeekBegin(c);
		return c;
